...
<!-- ======================================================== pre survey ======================================================================= -->		
	<div class="row font-1" id="survey_info">
		...
		<p>La seconda domanda riguarda lo stimare il prezzo (in euro) del prodotto rappresentato (o di un prodotto equivalente se non hai familiarità con quella specifica marca) e scrivere il prezzo nella casella di testo.</p>
