...
<!-- ======================================================== pre survey ======================================================================= -->		
	<div class="row font-1" id="survey_info">
		...
		<p>The second question involves estimating the price (in Canadian dollars) of the pictured item (or its equivalent if you are not familiar with that specific brand) and typing your estimated price in a text box.</p>
